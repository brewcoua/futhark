...
- **`tofu-writer`**: write on the node folders the two writing modules target, and nothing else.
  ...
  `/nodes/kenaz/bifrost`, `/nodes/kenaz/vane` and `/nodes/kenaz/local-deep-research`. See
...
| `/nodes/kenaz/local-deep-research` | none, leave empty                                                                                           | written by `just tf apply bifrost`                                                                                                                |
